        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {!showForgot ? (
            ...
            <>
              ...
              {otpVerified && (
                <>
                  <input type="password" placeholder="New Password" className="w-full mt-2 border px-3 py-2 rounded" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} />
                  <button type="button" className="w-full bg-purple-500 text-white py-2 rounded mt-2" onClick={handlePasswordReset}>Reset Password</button>
                </>
              )}
            </>
          )}
